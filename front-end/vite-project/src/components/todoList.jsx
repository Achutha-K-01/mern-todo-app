function TodoList({ todoList, handleCheck, handleDelete, filterType, handleEdit }) {
    return (
        <>
            <div style={{fontSize: "8px", fontWeight: 600,textAlign:"center", display: "flex", alignItems: "center", margin: "20px 0px 8px 0px", padding: "6px 0px", backgroundColor: "rgb(54, 96, 102)",color: "white", boxShadow: "0px 0px 2px 0px #9b9b9b", borderRadius: "2px" }}>
                    <div style={{ width: "10%" }}>
                        <p>Status</p>
                    </div>
            ...
            <div className="container" style={{ marginTop: "-8px", maxHeight: "260px", overflowY: "auto", scrollbarWidth: "thin" }}>
                {
                    filterType == "All" ?
                        todoList.map((task, idx) => (
                            <div className="taskList" key={idx} style={{ display: "flex", alignItems: "center", margin: "8px 0px", padding: "2px 0px", backgroundColor: "white", boxShadow: "0px 0px 2px 0px #9b9b9b", borderRadius: "2px" }}>
                                <div style={{ width: "8%" }}>
